    ...
    >
      <div className="pb-5">
        ...
        <div className="bg-[#282142] rounded-full flex items-center gap-2 py-3 px-4 mt-5">
          <img src={assets.search_icon} alt="search" className="w-3 mx-2" />
          <input
            type="text"
      ...
      <div className="flex flex-col ">
        {userDummyData.map((user, index) => (
          ...
          >
            ...
            {index > 2 && (
              <p className="absolute top-4 right-6 text-xs h-4 flex justify-center items-center aspect-[1/1] rounded-full bg-blue-500">
                {index}
              </p>
            )}
          </div>
